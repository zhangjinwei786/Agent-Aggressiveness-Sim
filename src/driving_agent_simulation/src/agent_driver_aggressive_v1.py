...
class agent_driver:
	...
	def potentialField(self):
		...
		goalPosX, goalPosY = self.getGoal(20, 15, 10)	# (distDiff, frontFistThreshold, goalOffset)
	...
	def getGoal(self, distDiff, frontFistThreshold, goalOffset):
		...
		for posInfo in neighborInfoList:
			...
			# Check if the neighbor vehicle is far ahead of the agent. If yes, jump to check next neighbor vehicle.
